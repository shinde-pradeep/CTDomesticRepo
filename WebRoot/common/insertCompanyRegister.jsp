			...
			<td colspan="2" valign="top">
				<table width="99%" border="0" align="center">
					<td width="100%" height="22">
						...
						<font size="2"><b><span class="main">Member
									Registration Update</span> </b> </font>
							...
							<TD colSpan=2>
								<TABLE cellSpacing=1 align="center" cellPadding=4 width="100%"
									...
									<TBODY>
										...
										<TR bgColor=#ffffff>
											<TH colSpan=3>
												<strong><b>Company Information</b> </strong>
											</TH>
										</TR>
										<TR bgColor=#ffffff>
											<td colspan=3>
									...
									<TBODY>
										<TR bgColor=#ffffff>
											<TH colSpan=2 height=20 width="50%">
												<strong><b>Primary Contact Information</b> </strong>
											</TH>
											<TH width="50%">
												<strong><b>Secondary Contact Information</b> </strong>
											</TH>
										</TR>
										<TR bgColor=#ffffff>
											...
											<td colspan="3">
												...
												<TABLE cellSpacing=1 cellPadding=5 width="100%"
													...
													<TR bgColor=#ffffff>
														...
														<td width="30%">
															<s:submit value="Save" action="addRegisterSave"
																theme="simple" id="button_style">
															</s:submit>
														</td>
													
														<TD width="30%">
															<s:submit  value="Reset" theme="simple" id="button_style"></s:submit>
														</TD>
													</TR>
												</table>
											</TD>
