		...
		<form id="frm_add_Transaction" cssClass="formular">
			<table border="1" width="100%" height="150">
				...
				<tr>
					...
					<td width="50%">
						<s:textfield name="raTraceability.transactionId" theme="simple" cssClass="validate[required,length[3,20]]"></s:textfield>
					</td>
				</tr>
				<tr>
					<td width="35%">
					...
					<td width="50%">
						<s:textfield name="raTraceability.buyerId" theme="simple" cssClass="validate[required,length[1,20]]"></s:textfield>
					</td>
				</tr>
				<tr>
					<td width="35%">
					...
					<td width="50%">
						<s:textfield name="raTraceability.sellerId" theme="simple" cssClass="validate[required,length[1,20]]"> </s:textfield>
					</td>
				</tr>
				<tr>
					<td width="35%">
				...
				<tr>
					...
					<td width="50%">
						<s:select list="listProducerMaster"
							name="raProducerMaster_ProducerId" value="raProducerMaster"
							headerKey="0" headerValue="--select--" listKey="producerId"
							listValue="contactName" theme="simple"></s:select>
					</td>
				...
				<tr>
					...
					<td width="50%">
						<s:select list="listDeliveryMonth" name="deliverMonthId" headerKey="0"
							...
							listKey="monthId" listValue="monthId" theme="simple"></s:select>
					</td>
				...
				<tr>
					...
					<td width="50%">
						<s:select name="loadPortNameId" list="listLoadport"
							listKey="loadId" listValue="description" value="raLoadPort"
				...
				<tr bgcolor="#FFFFFF">
					<th height="20" colspan="3" width="1342">
						<strong class="content"><b></b> </strong>
					</th>
				</tr>
			</table>
			...
			<s:else>
				<center><s:submit value="Save" action="addTransaction" theme="simple" id="button_style"></s:submit>
			</s:else>
				<s:submit value="Reset" action="addTransaction" theme="simple" id="button_style"></s:submit></center>
		</form>
	</body>
</html>
