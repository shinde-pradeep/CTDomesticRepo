...
window.parent.location.href='traders-form';
}
...
<form id="frm_add_trader" cssClass="formular">
		...
		<tr></tr>
					...
					<s:if test="raUserMaster.userId!=null">
						<s:submit value="Update" action="updateTrader" theme="simple" id="button_style"></s:submit>
					</s:if>
					<s:else>
						<s:submit value="Save" action="addTrader" theme="simple" id="button_style"></s:submit>
					</s:else>
