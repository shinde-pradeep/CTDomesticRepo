...
<script type="text/javascript"> 
       	function addAdmin()
       	{
			popUpWithServerData("/CTDomestic/addAdminInput.action", "Manage Admin",500,800);
		}
        function onInvokeExportAction(id) 
        { 
            var parameterString = createParameterStringForLimit(id); 
            location.href = '${pageContext.request.contextPath}/alluser.action?' + parameterString; 
        } 
...
<form name="adminForm"
	...
	<jmesa:tableModel id="tag" items="${listUser}" maxRows="8"
		exportTypes="pdf" maxRowsIncrements="4,8,12" stateAttr="restore"
		var="bean">
...
<s:hidden name="raUserMaster.userId" id="userId"
		theme="simple"></s:hidden>
		<input type="button" onclick="addAdmin()" value="Add" id="button_style"/>
		<input type="button" onclick="SendNotification()" value="Send Notification" id="button_style"/>
		<s:submit value="Deactive" action="DeactiveUser" align="center" theme="simple" id="button_style"></s:submit>
		<s:submit value="Active" action="ActiveUser" align="center" theme="simple" id="button_style"></s:submit>
		<s:submit value="Set as Primary User" action="adminPriamryUser" theme="simple" id="button_style"></s:submit>
