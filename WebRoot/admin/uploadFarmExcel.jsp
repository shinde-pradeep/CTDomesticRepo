		...
		<TD>
			...
			<table width="50%" border="0" align="center" cellpadding="2"
				...
				<s:form  id="frm_add_prod"
					...
					<s:textfield name="raProducerMaster.producerId"></s:textfield>
					<s:actionerror />
					<tr valign="top">
						<th colspan="2">
					...
					<tr>
						...
						<td><s:submit value="Upload" theme="simple" action="uploadFarm" id="button_style"/></td>
						<td><s:reset theme="simple" id="button_style"></s:reset></td>
					</tr>
