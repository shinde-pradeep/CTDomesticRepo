...
window.parent.location.href='producersUser';
}

$(document).ready(function() {
				$("#frm_add_producer").validationEngine()
				});
</script>
</head>
<%--   **********    --%>
<body>
<form id="frm_add_producer" cssClass="formular">
		...
		<tr><td>
			<table width="100">
				<tbody>
					...
					<tr><td>UserID*</td><td><s:textfield name="raUserMaster.loginName" theme="simple" cssClass="validate[required,length[3,20]]"></s:textfield></td></tr>
					<tr><td>Email ID*</td><td><s:textfield name="raUserMaster.email" theme="simple" cssClass="validate[required,length[3,20]]"></s:textfield></td></tr>
					...
					<tr><td colspan="2"><s:select label="User Type" name="raUserMaster.userType" list="{'admin','traders','producers'}"></s:select></td></tr>
			...
			<table width="100">
				<tbody>
					...
					<tr><td>Postal Code/Zip*</td><td><s:textfield name="raUserMaster.zip" theme="simple" cssClass="validate[required,length[3,20]]"></s:textfield></td></tr>
					<tr><td>Producer*</td><td><s:select list="listProducer" name="producerTraderId"  value="raProducerMaster" headerKey="0" headerValue="--select--"  listKey="producerId" listValue="orignizationName"></s:select></td></tr>
					<tr><td>Company*</td><td><s:select list="listCompany" name="companyTraderId"  value="raCompanyMaster" headerKey="0" headerValue="--select--"  listKey="companyId" listValue="companyName"></s:select></td></tr>
					<tr><td>State*</td><td><s:select list="listState" name="stateTraderName"  value="raStateMaster" headerKey="0" headerValue="--select--"  listKey="stateId" listValue="stateType"></s:select></td></tr>
		...
		<tr></tr>
					...
					<s:if test="raUserMaster.userId!=null">
						<s:submit value="Update" action="updateProducer" theme="simple" id="button_style"></s:submit>
					</s:if>
					<s:else>
						<s:submit value="Save" action="addProducer" theme="simple" id="button_style"></s:submit>
					</s:else>
