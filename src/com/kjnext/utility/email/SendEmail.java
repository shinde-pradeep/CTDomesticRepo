...
/**
 * @author kiran
 * Class is created to send the Email with multiple attachments, CC , BCC, subject, to and from  
 */
...
public class SendEmail {
     ...
     *
     * @param p_to The email address of who the message is to. e.g. "nchopra@test.com"
     * @throws MessagingException If an error occurs.
     ...
     *
     * @param p_msgFrom Email address of who the message is from. e.g. "nchopra@test.com"
     * @param p_msgTo Email address of who the message is to. e.g. "nchopra@test.com"
     ...
     * @param p_msgTo Email address of who the message is to. e.g. "nchopra@test.com"
     * @param p_msgToText The textual name of who the message is to. e.g. "Nitin Chopra"
     * @param p_msgSubject Subject for the forwarded email message.
     * @param p_msgBody Body of the forwarded email message.
     * @param msgOrig The original MimeMessage that is being forwarded.
     * @throws MessagingException If an error occurs.
    ...
    public void addFileAttachment(String p_fileName) throws MessagingException {
        ...
        */
        if(logger.isInfoEnabled()){
        	logger.info("Attached File: "+ p_fileName);
        }
    ...
    public void sendMsg() throws MessagingException {
        ...
        */    	
        ...
        /**
         *  New method for sending so that we can support SMTP authentication
         */
    ...
    /*public static void main(String args[]) {    
        try {
            ...
            ed.setTo("narendrakumar@kjnext.com");
            //ed.setCC("nchopra@eximware.com");
            //ed.setBCC("nchopra@eximware.com");
            ed.setFrom("narendrakumar@kjnext.com", "Sumit Ramteke");
